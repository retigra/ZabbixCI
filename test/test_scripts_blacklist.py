...
class TestScriptsBlacklist(BaseScripts, unittest.IsolatedAsyncioTestCase):
    def setUp(self):
        super().setUp()
        self.settings.SCRIPT_BLACKLIST = "Not existing script,Not existing script 2"
    ...
    async def test_script_delete(self):
        ...
        self.settings.SCRIPT_BLACKLIST = "Traceroute"
